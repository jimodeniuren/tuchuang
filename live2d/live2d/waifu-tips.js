...
// 后端接口
live2d_settings['modelAPI']             = '//live2d.fghrsh.net/api/';   // 自建 API 修改这里(注意:前面要加上自己的域名（前提是你把api文件放在网站根目录）)
...
live2d_settings['homePageUrl']          = 'https://www.qqzzyy.xyz/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.qqzzyy.xyz/';   // 关于页地址, '{URL 网址}'
